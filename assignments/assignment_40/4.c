...
int countgreaternum(PNODE head,int No){
    int i=0;
    while(head!=NULL){
        if((head->data)>No){
           i++;
...
int main()
{
    ...
    while(choice != 0)
    {
        ...
        printf("7. Display\n");
        printf("8. Count\n");
        printf("9.count greater number than X\n");
        printf("0. Exit\n");
        ...
        switch(choice)
        {
            ...
            case 9:
                printf("Enter the number to check how many numbers are grater than that number:");
                scanf("%d",&No);
                printf("the grater num :%d",countgreaternum(First,No));
